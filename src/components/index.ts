...
export { default as ColorTick } from './colorTick/ColorTick';
export { default as StatusTick } from './statusTick/StatusTick';
...
export { default as AlertPopup, PopupType, type AlertPopupProps } from './alertPopup/AlertPopup';
